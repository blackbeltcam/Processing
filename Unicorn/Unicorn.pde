...
void setup() {
  ...
  rainbow = loadImage("rainbow-7.jpg");  // 2. Change this to match your file name. 
  ...
  unicorn = loadImage("Unicorn-Clipart_7.png"); // 5. Change this to match your file name.
}

void draw() {
  // 6. Draw the unicorn using: image(PImage image, int xPosition, int yPosition)
 image(unicorn,mouse,10)
